...
class ModelBase extends Model
{
    ...
    public function getCommentsWithVotes($postId = false)
    {
        ...
        $comment = new \Phanbook\Models\Comments();
        $params = [Vote::OBJECT_COMMENTS, Vote::OBJECT_COMMENTS, ($postId ? $postId : $this->getId())];
    ...
    public function setNotification($userId, $postId, $postReplyId, $type)
    {
        ...
        $notification->setCommentsId($postReplyId);
    ...
    public function setActivityNotifications($userId, $postId, $postReplyId, $userOriginId, $type)
    {
        ...
        ;
        $activity->setCommentsId($postReplyId);
